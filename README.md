...
Userscripts to open various apps in [Live Container](https://github.com/khcrysalis/LiveContainer) on iOS.

**Featured**: Strava OAuth support for Fitbod integration - seamlessly authorize Strava within Fitbod running in Live Container.

Originally forked from [Open-In-Apollo](https://github.com/AnthonyGress/Open-In-Apollo) by Anthony Gress. Additional scripts adapted for Twitter, YouTube, Instagram, Spotify, and Fitbod.
...
- **[Userscripts Safari Extension](https://apps.apple.com/us/app/userscripts/id1463298887)** (free)
- **[Live Container](https://github.com/khcrysalis/LiveContainer)** - iOS app container
- iOS device (tested on iOS 18.2.1)
...
- It will redirect to Live Container briefly and open the app inside Live Container.
...
**Features**:
- ✅ No intermediate web pages
- ✅ No 404 errors
- ✅ Single userscript solution
- ✅ Seamless user experience

## Testing

**Strava-Fitbod OAuth**: Tested and working on iOS 18.2.1 with Live Container 3.1.59-release

**Other scripts**: Tested on iOS 18.2.1 with Apollo 1.15.11 + ApolloPatcher 0.0.9 and Live Container 3.1.59-release

## Credits

- Original [Open-In-Apollo](https://github.com/AnthonyGress/Open-In-Apollo) by Anthony Gress
- Twitter script based on [ryuya0124's gist](https://gist.github.com/ryuya0124/e6e59ceba8f03bf40f3b5accedc52e44)
- Strava OAuth implementation: Custom solution for Live Container integration
